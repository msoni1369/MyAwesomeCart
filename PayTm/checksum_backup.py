"""pip install pycryptodome(install this package to run the below script) 
because this file is written in 3.x and we are Working in 3.7 so for this 
code to work we have to install "pycryptodome". """

#this file is provided by paytm and are avaiable at:
#https://github.com/Paytm-Payments/Paytm_Web_Sample_Kit_Python/blob/master/pythonKit%203.X/
...
def __encode__(to_encode, iv, key):
    ...
    # Encrypt
    #AES() function needs 'utf-8' encoding so we are modifying below line
    #c = AES.new(key, AES.MODE_CBC, iv)
    c = AES.new(key.encode('utf-8'), AES.MODE_CBC, iv.encode('utf-8'))
    
    #encrypt() also takes 'utf-8' so we are modifying below line
